...
while ($true) {
    ...
    Write-Host "[$messageNumber] $timestamp - Client ($($remoteEndPoint.Address):$($remoteEndPoint.Port)): $receivedMessage"
    ...
    Write-Host "[$messageNumber] $timestamp - Server: $response"
