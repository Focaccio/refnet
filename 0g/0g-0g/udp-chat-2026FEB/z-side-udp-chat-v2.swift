...
final class UDPChatApp: NSObject, NSApplicationDelegate, NSWindowDelegate, NSTextViewDelegate {
    private let displayName = "Side Z"
    private let sendLabel = "Z->A"
    private let recvLabel = "A->Z"
    private let probePayloadText = "ZZZZZ-ZZZZZ-ZZZZZ-ZZZZZ-ZZZZZ"
    private let remoteProbePayloadText = "AAAAA-AAAAA-AAAAA-AAAAA-AAAAA"
    private let maxInputLines = 3
    private let sendFromA = false
